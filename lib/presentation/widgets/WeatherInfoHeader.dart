...
import 'package:sky_cast/presentation/screens/five_weather_screen/five_weather_screen.dart';
          ...
          children: [
                          ...
                          child: RichText(
                            ...
                            text: TextSpan(
                              ...
                              children: [
                                TextSpan(
                                  text:
                                      Country.tryParse(weatherProv.weather.countryCode)?.name,
            ...
            weatherProv.isLoading
              ...
              onPressed: () => Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      FiveWeatherScreen(latLng: weatherProv.currentLocation!),
                ),
              ),
              child: const Text("Five Days Forecast"),
            )
            // ClipRRect(
